...
BFormInst::encodeBeq(unsigned rs1v, unsigned rs2v, int imm)
{
  ...
  bits.rs1 = rs1v & 0x1f;
  bits.rs2 = rs2v & 0x1f;
  bits.imm4_1 = imm & 0x0f;
  bits.imm10_5 = (imm >> 4) & 0x3f;
  bits.imm11 = (imm >> 10) & 0x01;
  //sign extension
  if((imm >> 11)){
    bits.imm12 = -1;
  }
  else{
    bits.imm12 = (imm >> 11) & 0x01;
  }
...
JFormInst::encodeJal(uint32_t rdv, int offset)
{
  ...
  bits.opcode = 0x6f;
  bits.rd = rdv & 0x1f;
  bits.imm19_12 = (offset >> 11) & 0xff;
  bits.imm11 = (offset >> 10) & 0x01;
  bits.imm10_1 = offset & 0x3ff;
  //sign extension
  if((offset >> 11)){
    bits.imm20 = -1;
  }
  else{
    bits.imm20 = (offset >> 19) & 0x01;
  }

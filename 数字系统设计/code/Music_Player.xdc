...
## LEDs
set_property -dict {PACKAGE_PIN T14 IOSTANDARD LVCMOS25} [get_ports play]
#set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS25 } [get_ports { led[1] }]; #IO_L15N_T2_DQS_13 Sch=led[1]
set_property -dict {PACKAGE_PIN T16 IOSTANDARD LVCMOS25} [get_ports {song[0]}]
set_property -dict {PACKAGE_PIN U16 IOSTANDARD LVCMOS25} [get_ports {song[1]}]
...
set_property -dict {PACKAGE_PIN D22 IOSTANDARD LVCMOS12} [get_ports next_button]
#set_property -dict { PACKAGE_PIN C22 IOSTANDARD LVCMOS12 } [get_ports { play_button }]; #IO_L20P_T3_16 Sch=btnl
set_property -dict {PACKAGE_PIN D14 IOSTANDARD LVCMOS12} [get_ports play_button]
...
## Audio Codec
set_property -dict {PACKAGE_PIN T4 IOSTANDARD LVCMOS33} [get_ports ADC_SDATA]
set_property -dict {PACKAGE_PIN T5 IOSTANDARD LVCMOS33} [get_ports BCLK]
set_property -dict {PACKAGE_PIN W6 IOSTANDARD LVCMOS33} [get_ports DAC_SDATA]
set_property -dict {PACKAGE_PIN U5 IOSTANDARD LVCMOS33} [get_ports LRCLK]
set_property -dict {PACKAGE_PIN U6 IOSTANDARD LVCMOS33} [get_ports MCLK]
